...
namespace std
{
    ...
    struct hash<in6_addr>
    {
        ...
        {
            return kapps::core::hashFields(addr.__u6_addr.__u6_addr32[0],
...
public:
    ...
    {
        return core::hashFields(sourceAddress(), sourcePort(), destAddress(),
            destPort(), protocol());
    }
...
KAPPS_CORE_STD_HASH_TEMPLATE(kapps::net::PacketFlow<T>, class T)
